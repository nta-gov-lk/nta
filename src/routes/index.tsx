...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "National Television Academy — Shape Your Future in Television",
      },
      {
        property: "og:description",
        content:
          "Practical, studio-based media training from Sri Lanka's national television broadcaster.",
      },
  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-r from-ink/95 via-ink/80 to-primary/20"
          aria-hidden
        />
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-24 sm:py-32 lg:grid-cols-[minmax(0,1fr)_auto]">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
              Practical, studio-based training in acting, presenting, camera, lighting and voice —
              taught by working broadcast professionals inside Sri Lanka's national television
              facilities.
            </p>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
              Programmes are short, intensive and practical. Every course ends with produced work: a
              teledrama, a live bulletin, a lighting portfolio or a voice showreel that begins a
              professional career.
            </p>
            <Link
              to="/about"
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              src={studioA}
              alt="Student presenting from the studio news desk"
              loading="lazy"
              className="h-64 w-full rounded-xl object-cover sm:h-80"
            />
            <img
              src={studioB}
              alt="Students operating a broadcast camera"
              loading="lazy"
        ...
        <div className="mx-auto grid max-w-7xl gap-8 text-center sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s) => (
            <div key={s.label}>
              ...
              <p className="mt-2 text-sm font-semibold uppercase tracking-wide text-primary-foreground/85">
                {s.label}
              </p>
            </div>
          ))}
      ...
      <Section>
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
          <SectionHeading
            ...
            intro="Four programmes covering performance, presenting, technical craft and voice."
          />
          <Link
            to="/courses"
      ...
      <Section className="bg-card">
        <SectionHeading
          ...
          title="Why Choose the National Television Academy"
          align="center"
        />
      ...
      <Section>
        <SectionHeading
          eyebrow="Heritage"
          title="Four Decades of National Broadcasting"
          intro="The academy stands on the history of the Sri Lanka Rupavahini Corporation."
        />
      ...
      <section className="relative overflow-hidden bg-ink px-4 py-20 text-white">
        <div
          className="pointer-events-none absolute -left-20 top-0 h-72 w-72 rounded-full bg-primary/50 blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-gold/25 blur-3xl"
          aria-hidden
        />
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-white/75">
            Applications are accepted across all four programmes. Choose your course, submit your
            application and book your audition or assessment.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              to="/apply"
              className="rounded-md bg-gold px-7 py-3.5 text-sm font-bold text-gold-foreground hover:bg-white"
            >
              Apply Now
            </Link>
            <Link
              to="/admissions"
              className="rounded-md border-2 border-white/70 px-7 py-3.5 text-sm font-bold text-white hover:bg-white hover:text-primary"
            >
              Admissions Guide
            </Link>
          </div>
      ...
      <Section className="bg-card" id="contact">
        <SectionHeading
          eyebrow="Contact"
          title="Get in Touch"
          intro="Contact details below are placeholders pending official confirmation."
        />
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          <div className="space-y-5">
            ...
            <div className="relative h-56 overflow-hidden rounded-xl border-2 border-gold bg-gold-soft">
              <iframe
